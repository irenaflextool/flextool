...
set commodityTimeParam within commodityPeriodParam;
set nodeParam;
...
param pd_profile {profile, period};
...
set commodity__param__branch__time dimen 5 within {commodity, commodityTimeParam, time_branch_all, time, time};
set group__param__branch__time dimen 5 within {group, groupTimeParam, time_branch_all, time, time};
...
table data IN 'CSV' 'solve_data/pbt_commodity.csv' : commodity__param__branch__time <- [commodity, commodityParam, branch, time_start, time], pbt_commodity~pbt_commodity;
table data IN 'CSV' 'solve_data/pbt_group.csv' : group__param__branch__time <- [group, groupParam, branch, time_start, time], pbt_group~pbt_group;
...
param pdtCommodity {(c, param) in commodity__TimeParam, (d, t) in dt} :=
      + if exists{(d,ts) in period__time_first, (d,tb) in solve_branch__time_branch: (c, param, tb, ts, t) in commodity__param__branch__time} 1 
        ...
        else if (c, param, t) in commodity__param__time
...
param pdtGroup {(c, param) in group__TimeParam, (d, t) in dt} :=
      + if exists{(d,ts) in period__time_first, (d,tb) in solve_branch__time_branch: (g, param, tb, ts, t) in group__param__branch__time} 1 
        ...
        else if exists{(p,tb) in solve_branch__time_branch, (d,ts) in period__time_first: (p,d) in period__branch && (g, param, tb, ts, t) in group__param__branch__time} 1
             then sum{(p,tb) in solve_branch__time_branch, (d,ts) in period__time_first: (p,d) in period__branch} pbt_group[g, param, tb, ts, t] 
        else if (g, param, t) in group__param__time
